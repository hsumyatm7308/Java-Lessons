...
public class Employee_Management {
	...
	public static void main(String[] args) {
		...
		System.out.println("5. Employee with Minimum Salary");
		System.out.println("6. Employee with Maximum Salary");
		...
		try {
			while (choice.equalsIgnoreCase("y")) {
				...
				case 2:
					...
					break;
				case 3:
					System.out.println("Caculate Total Salary");
					clcTotalSalary();
					break;
				case 4:
					System.out.println("Caculate Average Salary");
					clcAvgSalary();
					break;
				case 5:
	...
	public static double clcTotalSalary() {
		double total = 0;
	...
	public static double clcAvgSalary() {
		double avg = clcTotalSalary() / emplist.size();
		return avg;
	}
